                ...
                <div class="navbar">
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="sub-list">
                                <li>
                                    <a href="./crush-all.html">Giày đi với crush</a>
                                </li>
                                <li>
                                    <a href="./sport-all.html">Giày thể thao</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="./sale-all.html"><i>KHUYẾN MÃI</i></a>
                        </li>
                        <li>
                            ...
                            <div class="header_cart-wrap">
                                ...
                                <div class="header_cart-list">
                                    ...
                                    <div class="total_price">
                                        ...
                                        <div class="number">3,200,000đ</div>
                                    </div>
                                    <a href="./cart.html" class="header_cart-view-cart action-btn"> Xem Giỏ Hàng </a>
                                </div>
                            </div>
                        </div>
                    </div>
