...
<html lang="en">
    ...
    <body>
        <%
            ArrayList<ProductForSale> products = (ArrayList<ProductForSale>) getServletContext().getAttribute("products");  
                ...
                <div class="navbar">
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="sub-list">
                                <li>
                                    <a href="#saleoff10_product">KHUYẾN MÃI 10%</a>
                                </li>
                                <li>
                        ...
                        <%if(user != null) {%>
                        <li>
                            <a href="account"><i>${user.getFullName().toUpperCase()}</i></a>
                            <ul class="sub-list">
                                <a>
                        ...
                        <%} else {%>
                        <li>
                            <a href="login.jsp"><i>ĐĂNG NHẬP</i></a>
                        </li>
                        <li>
                            <a href="register.jsp"><i>ĐĂNG KÝ TÀI KHOẢN</i></a>
                        </li>
                        <%}%>
                    </ul>
                    <!-- Searchbar -->
        ...
        <div class="product">
            <div class="sub_content">
                        ...
                        <ul class="list">
                            <%for(int i = 0; i < 5; i++) {
                                ...
                                <li class="list_item">
                                    ...
                                    <a href="#!">
                                        <img
                                        src="<%=products.get(i).getImage()%>"
                                        alt="<%=products.get(i).getName()%>"
                                        class="img"
                                        />
                                        ...
                                        <%if(user != null) {%>
                                            <form id="cart-form" method="post" action="upd-ct">
                                                ...
                                                <input type="number" id="<%=number.concat(Integer.toString(i))%>" name = "quantity" value="0" />
                                    ...
                                    <span class="price"><%=products.get(i).getUnitPrice()%>đ</span>
                                </li>
                            <%}%>
                        </ul>
                    </div>
                                    ...
                                    <a href="#!">
                                        ...
                                        <%if(user != null) {%>
                                            <form id="cart-form" method="post" action="upd-ct">
                                                ...
                                                <input type="hidden" name = "userJson" value = "<%=URLEncoder.encode(userJson, "UTF-8")%>">
                                                <input type="hidden" name = "productJson" value = "<%=URLEncoder.encode(productJson, "UTF-8")%>">
                                                <input type="submit" id="submit-button" value = "Thêm">
                                            </form>
                                        <%}%>
                                    </a>
                                    <a class="star" href="#xemdanhgia">
                ...
                <div class="hot_product" id="saleoff10_product">
                    <div class="title">
                        <h2 class="heading action-btn">
                    ...
                    <div class="product_list">
                        <ul class="list">
                            <%for(int i = 10; i < 15; i++) {
                                String productJson = objectMapper.writeValueAsString(products.get(i));
                                products.set(i, new ProductForSale(products.get(i).getImage(),
                                ...
                                <li class="list_item">
                                    <span class="status status_sale">-10%</span>
                                    <a href="#!">
                                        <img
                                        src="<%=products.get(i).getImage()%>"
                                        alt="<%=products.get(i).getName()%>"
                                        ...
                                        <%if(user != null) {%>
                                            <form id="cart-form" method="post" action="upd-ct">
                                                ...
                                                <input type="hidden" name = "userJson" value = "<%=URLEncoder.encode(userJson, "UTF-8")%>">
                                                <input type="hidden" name = "productJson" value = "<%=URLEncoder.encode(productJson, "UTF-8")%>">
                                                <input type="hidden" name = "saleoff" value = "0.9">
                                                <input type="submit" id="submit-button" value = "Thêm">
                                            </form>
                                        <%}%>
                                    </a>
                                    ...
                                    <span class="price"><%=Math.round(0.9 * products.get(i).getUnitPrice())%>đ</span>
                                    <span class="old_price"><%=products.get(i).getUnitPrice()%>đ</span>
                                </li>
                            <%}%>
                        </ul>
                    </div>
